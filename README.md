...
Forty-seven descriptive and exploratory figures, each with its numbers as a companion
...
[`figures/`](figures/README.md) holds forty-seven figures over the dataset —
